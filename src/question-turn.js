...
// 语音服务会先给片段、再给更完整的回写文本。提交给检索/LLM 的只能是
// 最终的一道题，不能把展示中的前一段转写一起当作第二次搜索上下文。
export function prepareQuestionForSubmission(text = "") {
  return extractLatestQuestionTurn(normalizeAsrQuestion(text));
}
